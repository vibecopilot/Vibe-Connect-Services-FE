...
const TrainerForm: React.FC<TrainerFormProps> = ({ trainer, onSave, onCancel, isEdit = false, isView = false }) => {
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen" style={{ fontFamily: "PT Sans, sans-serif" }}>
      ...
      <div className="mb-6 text-center">
        <h1 className="text-2xl font-semibold text-gray-800 mb-6">{getFormTitle()}</h1>

        {/* Image Upload positioned above form */}
        {/* {!isView && (
          // <div className="mb-6">
          //   <ImageUpload onImageUpload={handleImageUpload} currentImage={formData.profileImage} />
          // </div>
        )} */}
      ...
      {/* Centered Form with increased width */}
