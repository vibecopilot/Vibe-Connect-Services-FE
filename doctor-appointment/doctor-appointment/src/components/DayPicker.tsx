  ...
  return (
    <div className="w-full">
      ...
      <button
        ...
        className="w-full bg-[#7991BB] text-white px-4 py-2 rounded mb-4 hover:bg-[#6a82a8]"
      >
        Select Days
      </button>
      ...
      {showDaySelection && (
        <div className="border rounded p-4 bg-white">
          ...
          <div className="flex gap-2 justify-center">
            ...
            <button onClick={handleSet} className="px-4 py-1 text-[#7991BB] hover:text-[#6a82a8]">
              Set
            </button>
          </div>
        </div>
