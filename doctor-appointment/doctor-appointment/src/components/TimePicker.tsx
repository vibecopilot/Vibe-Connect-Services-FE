        ...
        <div className="flex flex-col items-center mt-6">
          ...
          <div className="relative w-32 h-32 border-2 border-gray-300 rounded-full mb-4">
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-2 h-2 bg-[#7991BB] rounded-full"></div>
            </div>
              ...
              return (
                <button
                  ...
                  className={`absolute w-6 h-6 text-xs rounded-full flex items-center justify-center transform -translate-x-1/2 -translate-y-1/2 ${
                    selectedHour === hour ? "bg-[#7991BB] text-white" : "text-gray-600 hover:bg-gray-100"
                  }`}
                  style={{
                    left: `${x}%`,
                    top: `${y}%`,
            ...
            {/* Clock Hand */}
            <div
              className="absolute w-0.5 bg-[#7991BB] origin-bottom"
              style={{
                height: "35%",
                left: "50%",
                top: "15%",
          ...
          <div className="flex border rounded overflow-hidden">
            <button
              onClick={() => setAmPm("AM")}
              className={`px-3 py-1 text-sm ${amPm === "AM" ? "bg-[#7991BB] text-white" : "bg-gray-100 text-gray-700"}`}
            >
              AM
            </button>
            <button
              onClick={() => setAmPm("PM")}
              className={`px-3 py-1 text-sm ${amPm === "PM" ? "bg-[#7991BB] text-white" : "bg-gray-100 text-gray-700"}`}
            >
              PM
            </button>
          </div>
