...
const TemplateSelection = () => {
  ...
  const { selectedCategory, selectedTemplate } = useTemplate()

  const handleNext = () => {
    // Navigate to card editor instead of theme selection
  ...
  const FrontComponent = selectedTemplate.preview.front
  const BackComponent = selectedTemplate.preview.back
