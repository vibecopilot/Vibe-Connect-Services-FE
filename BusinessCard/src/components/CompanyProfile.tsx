...
const CompanyProfile = () => {
  ...
  const { data, updateCompanyLogo } = useBusinessCard()
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-md mx-auto px-6 py-8 relative">
        ...
        <h1 className="text-2xl font-semibold text-center text-gray-800 mb-6">Add Company Logo</h1>
        ...
        <div className="bg-[#E6EAF3] w-full max-w-sm mx-auto rounded-full flex items-center justify-center px-8 py-3 text-sm mb-8 shadow-md">
          ...
          <span className="text-[#4569A0]">This logo will be displayed on your card</span>
        </div>
        ...
        <div className="flex justify-center mb-8">
          {data.companyLogo ? (
            <div
              className="w-24 h-24 rounded-lg bg-gray-200 flex items-center justify-center cursor-pointer overflow-hidden border-2 border-gray-300"
            ...
            <div
              className="w-24 h-24 rounded-lg bg-gray-200 flex items-center justify-center cursor-pointer hover:bg-gray-300 transition-colors border-2 border-gray-300"
              onClick={handleAddLogo}
            >
      ...
      {showPreview && (
        <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-3 w-64 shadow-xl">
            {/* Dark Border Frame with Centered Logo */}
            <div className="w-full aspect-square bg-gray-800 rounded-md mb-3 overflow-hidden">
              <div className="w-full h-full bg-white rounded-md overflow-hidden flex items-center justify-center p-4">
                {tempLogo && (
                  <img
