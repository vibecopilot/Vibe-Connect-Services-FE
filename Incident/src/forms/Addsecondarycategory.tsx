...
interface AddSecondaryCategoryProps {
  onSubmit: (categoryType: string) => void;
  onCancel: () => void;
}

const AddSecondaryCategory: React.FC<AddSecondaryCategoryProps> = ({
  onSubmit,
  onCancel,
}) => {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 w-full mt-2 text-gray-600" style={{ fontFamily: "'PT Sans', sans-serif" }}>
