        ...
        <div className="bg-white p-4 rounded-lg shadow space-y-4">
          <div className="pb-4">
            <div className="flex justify-between items-center mb-4 pb-4 border-b border-black-200">
              <h2 className="text-lg font-bold">Broadcast Info</h2>
              <button 
                type="button"
            ...
            <div className="mb-4">
              <label className="block mb-1 font-semibold">Broadcasts photo or video</label>
            ...
            <div className="flex gap-4">
              {["All", "Individuals", "Groups"].map(option => (
                <button
                  key={option}
                  type="button"
                  className={`px-4 py-2 rounded border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#7991BB] ${
                    shareMessage === option 
