  ...
  import ReactDatePicker from "../components/ReactDatePicker" // Changed to ReactDatePicker
  ...
  export default function OperationalHoursTab({ searchQuery }: OperationalHoursTabProps) {
    ...
    const handleRepeatEveryYearCheckboxChange = (e: React.ChangeEvent<HTMLInputElement>) => {
      setFormData((prev) => ({ ...prev, repeatEveryYear: e.target.checked }))
    }
    ...
    const handleScheduleCheckboxChange = (day: Weekday, e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        <div className="space-y-4">
          ...
          <div className="text-left">
            <Checkbox
              ...
              onChange={handleRepeatEveryYearCheckboxChange}
            />
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {weekdays.map((day, index) => (
              <div key={day} className="grid grid-cols-[120px_180px_600px_1px_380px] gap-4 items-center py-2">
