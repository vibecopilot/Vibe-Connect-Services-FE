  ...
  const viewModalContent = viewingSLA ? (
    <div className="space-y-4" style={{ fontFamily: "PT Sans, sans-serif" }}>
      <div>
        ...
        <p className="text-gray-600">{viewingSLA.name}</p>
      </div>
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1">Description</label>
        <p className="text-gray-600">{viewingSLA.description}</p>
      </div>
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1">Response Time</label>
        <p className="text-gray-600">{viewingSLA.responseTime}</p>
      </div>
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1">Resolution Time</label>
        <p className="text-gray-600">{viewingSLA.resolutionTime}</p>
      </div>
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1">Status</label>
        <p className="text-gray-600">{viewingSLA.status ? "Active" : "Inactive"}</p>
      </div>
    </div>
  ) : null
