              ...
              filteredCourses.map((course) => (
                <tr key={course.id} className="hover:bg-gray-50">
                  ...
                  <td className="p-3 border-b border-gray-400 text-center">
                    {course.status === "Pending" && (
                      <div className="flex justify-center items-center gap-2">
                        <button className="px-3 py-1 bg-green-100 text-green-700 text-sm rounded-md hover:bg-green-200 flex items-center gap-1">
                          <Check className="h-3 w-3" />
                          Approve
                        </button>
                        <button className="px-3 py-1 bg-red-100 text-red-700 text-sm rounded-md hover:bg-red-200 flex items-center gap-1">
                          <X className="h-3 w-3" />
                          Reject
                        </button>
                      </div>
