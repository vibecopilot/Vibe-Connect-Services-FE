...
type CourseViewType = "Instructor" | "Admin" | "Employee";
      ...
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="w-full mx-auto">
          <div className="bg-gray-200 px-6 py-3 mb-6">
            <h1 className="text-xl font-semibold text-gray-600 text-center">Create Course</h1>
          </div>
                  ...
                  <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium ${
                      currentStep === step.key
                        ...
                        : "bg-gray-300 text-gray-600 border-2 border-blue-400"
                    }`}
                  >
                    {index + 1}
                  </div>
                  <span className="mt-2 text-sm text-[#5e5e5e] font-medium">{step.label}</span>
                </div>
                {index < 4 && <div className="w-50 h-0.5 bg-gray-300 mx-4" />}
              </div>
            ))}
          </div>
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-sm">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div className="inline-flex border border-gray-300 rounded-md px-4 py-3 bg-gray-50 mb-6">
          <div className="flex gap-6">
            {(["Instructor", "Admin", "Employee"] as CourseViewType[]).map(
              (view) => (
                <label
                  key={view}
                  ...
                  <tr key={course.id} className="hover:bg-gray-50">
                    ...
                    <td className="p-3 border-b border-gray-400">
                      <div className="flex items-center gap-3">
                        ...
                        />
                        <div>
                          <p className="font-normal">{course.title}</p>
                        ...
                        {course.status === "Pending" && (
                          <div className="flex gap-2">
                            <button
                              ...
                              className="px-3 py-1 bg-green-100 text-green-700 text-sm rounded-md hover:bg-green-200 flex items-center gap-1"
                            >
                            ...
                            <button
                              onClick={() =>
                                handleStatusChange(course.id, "Rejected")
                              }
                              className="px-3 py-1 bg-red-100 text-red-700 text-sm rounded-md hover:bg-red-200 flex items-center gap-1"
                            >
                              <X className="h-3 w-3" />
                              Reject
                            </button>
