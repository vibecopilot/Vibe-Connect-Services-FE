...
const Button: React.FC<React.ButtonHTMLAttributes<HTMLButtonElement> & { tooltip?: string }> = ({
  ...
  return (
    <button
      {...props}
      className={`px-4 py-2"bg-gray-100 text-gray-700 py-1 rounded border border-gray-300 hover:bg-gray-200 transition flex items-center gap-1 ${
        props.className || ''
      }`}
      title={tooltip}
...
const AssociationForm: React.FC = () => {
  ...
  const [associations, setAssociations] = useState<Association[]>([
    { id: 1, serviceName: 'Cobweb', assignedTo: 'Akshat Shrawat, Test User 2 Testing, Vibe User' },
    { id: 2, serviceName: 'Washroom', assignedTo: 'Akshat Shrawat, Test User 2 Testing, Vibe User' },
  ]);
  ...
  return (
    <div className="p-4 space-y-4" style={{ fontFamily: "'PT Sans', sans-serif",color: 'gray' }}>
      ...
      <div className="flex justify-between items-center mb-4 text-left" style={{ fontFamily: "'PT Sans', sans-serif" }}>
      ...
      <div className="flex items-center gap-4">
        ...
        <Button onClick={handleCreateActivity} tooltip="Create Association" className='mb-4 h-9'>
          Create Activity
        </Button>
      </div>
      ...
      {/* Success message box */}
      {showSuccessMessage && (
        <div className="flex items-center justify-center mt-4" style={{ fontFamily: "'PT Sans', sans-serif" }}>
      ...
      <div className="border rounded mt-4" style={{ fontFamily: "'PT Sans', sans-serif" }} >
