    ...
    <div className="service-desk-management">
      ...
      <div className="tab-content">
        <Routes>
          ...
          <Route
            path="/"
            element={<Navigate to="/servicedesk-management/category" replace />}
          />
          <Route
            path="/servicedesk-management"
            element={<Navigate to="/servicedesk-management/category" replace />}
          />
          
          {/* Service Desk Management Routes with searchQuery prop */}
          <Route
            path="/servicedesk-management/category"
            element={<CategoryTab searchQuery={searchQuery} />}
          />
          <Route
            path="/servicedesk-management/status"
            element={<StatusTab searchQuery={searchQuery} />}
          />
          <Route
            path="/servicedesk-management/level"
            element={<LevelTab searchQuery={searchQuery} />}
          />
          <Route
            path="/servicedesk-management/mode"
            element={<ModeTab searchQuery={searchQuery} />}
          />
          <Route
            path="/servicedesk-management/escalation"
            element={<EscalationTab searchQuery={searchQuery} />}
          />
          <Route
            path="/servicedesk-management/request"
            element={<RequestTab searchQuery={searchQuery} />}
          />
          <Route
            path="/servicedesk-management/task-type"
            element={<TaskTypeTab searchQuery={searchQuery} />}
          />
          <Route
            path="/servicedesk-management/worklog-type"
            element={<WorklogTypeTab searchQuery={searchQuery} />}
          />
          <Route
            path="/servicedesk-management/closure-code"
            element={<ClosureCodeTab searchQuery={searchQuery} />}
          />
