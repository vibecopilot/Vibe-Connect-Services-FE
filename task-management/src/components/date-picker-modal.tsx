...
const DatePickerModal = ({ onSave, onCancel }: DatePickerModalProps) => {
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      days.push(
        <button
          ...
          day === selectedDay ? "bg-[#7991BB] text-white" : "text-gray-900 hover:bg-gray-100"
          }`}
        >
          {day}
        </button>,
  ...
  onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = '#5e769d')}
  onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = '#7991BB')}
>
          Set
        </button>
      </div>
