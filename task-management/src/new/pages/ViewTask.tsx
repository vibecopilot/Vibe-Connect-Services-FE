...
const ViewTask = () => {
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
    ...
    // Update in store
    taskStore.updateTask(taskData.id, { [name]: value })
  }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-4">
              <TextInput label="Task Name:" name="name" value={taskData.name} onChange={handleInputChange} />
              ...
              <DatePicker label="Due Date:" name="dueDate" value={taskData.dueDate} onChange={handleInputChange} />
              ...
              <div>
                ...
                <FileUpload
                  onChange={(files) => {
                    const updatedTask = { ...taskData, attachments: files }
                    setTaskData(updatedTask)
                    taskStore.updateTask(taskData.id, { attachments: files })
                  }}
